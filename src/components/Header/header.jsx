        ...
        <nav className="bg-emerald-900">
            <div className="md:flex items-center justify-between py-2 px-8 md:px-12 sm:px-8">
                ...
                <div className="flex flex-col md:flex-row hidden md:block -mx-2">
                    <a href="#" href="#about" className="text-white rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">About</a>
                    <a href="#" className="text-white rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">Portfolio</a>
                    <a href="#" className="text-white rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">Contact</a>
                </div>
            </div>
        </nav>
